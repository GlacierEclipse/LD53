...
class EndDayScene extends Scene
{
    ...
    public function new() 
    {
        ...
        texts.push(new TextEntity(0, 80, "Target Reached!"));
        texts.push(new TextEntity(0, 100, "Completed Day " + LevelManager.currentLevel + "/5"));
        texts.push(new TextEntity(0, 200, "Enter to continue to next day"));
    ...
    override function update() 
    {
        ...
        if(Input.pressed("enter") && !tweenAlpha.active)
        {
            ...
            tweenAlpha.onComplete.bind(function() {
                ...
                Globals.gameScene.levelManager.buildNextLevel();
